...
<template>
  <div class="max-w-md mx-auto mt-10 p-6 bg-white rounded shadow-md">
    ...
    <form @submit.prevent="submitForm">
      ...
      <div class="mb-6">
        <button type="submit" class="w-full px-4 py-2 bg-indigo-600 border border-transparent rounded-md shadow-sm text-sm font-medium text-white hover:bg-indigo-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500">Reset Password</button>
      </div>
